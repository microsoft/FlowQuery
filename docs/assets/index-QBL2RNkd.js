...
var Zc;
function $s() {
    return (Zc || ((Zc = 1), (Ss.exports = Ap())), Ss.exports);
}
/**
 * @license React
...
var tf;
function Hp() {
    return (tf || ((tf = 1), (xs.exports = qp())), xs.exports);
}
var De = Hp();
const Wp = Df(De),
    Up = If({ __proto__: null, default: Wp }, [De]);
var gi = {},
    Bs = { exports: {} },
    ft = {},
    Ts = { exports: {} },
...
var nf;
function Kp() {
    return (nf || ((nf = 1), (Ts.exports = Vp())), Ts.exports);
}
/**
 * @license React
...
` + s[d].replace(" at new ", " at ");
    ...
    function Sn(e, t) {
        e.blockedOn === t &&
            ((e.blockedOn = null),
            Qi || ((Qi = !0), n.unstable_scheduleCallback(n.unstable_NormalPriority, ch)));
    }
    function Bn(e) {
        function t(s) {
            return Sn(s, e);
    ...
    for (var cl = 0; cl < du.length; cl++) {
        var fl = du[cl],
            Gh = fl.toLowerCase(),
            Xh = fl[0].toUpperCase() + fl.slice(1);
        nr(Gh, "on" + Xh);
    }
        ...
        if (!e[Co]) {
            ((e[Co] = !0),
                a.forEach(function (r) {
                    r !== "selectionchange" && (Yh.has(r) || dl(r, !1, e), dl(r, !0, e));
                }));
    ...
    function Nu(e) {
        ...
        function I(B, _, E) {
            if ((typeof _ == "string" && _ !== "") || typeof _ == "number")
                return ((_ = gs("" + _, B.mode, E)), (_.return = B), _);
                ...
                switch (E.$$typeof) {
                    ...
                    case G:
                        e: {
                            ...
                            ((_ = ys(E, B.mode, M)), (_.return = B), (B = _));
                        }
                        return d(B);
                    case A:
                        return ((ne = E._init), je(B, _, ne(E._payload), M));
                }
            ...
            return (typeof E == "string" && E !== "") || typeof E == "number"
                ? ((E = "" + E),
                  _ !== null && _.tag === 6
                      ...
                      : (r(B, _), (_ = gs(E, B.mode, M)), (_.return = B), (B = _)),
                  d(B))
                : r(B, _);
        }
        return je;
...
` +
    ...
    function Ec(e) {
        ...
        (t !== null && ((e.alternate = null), Ec(t)),
            ...
            e.tag === 5 &&
                ((t = e.stateNode),
                t !== null &&
                    (delete t[Dt], delete t[Dn], delete t[wl], delete t[np], delete t[op])),
            (e.stateNode = null),
            (e.return = null),
            (e.dependencies = null),
    ...
    ((Pa = function (e) {
        ...
        (ya = hs),
        (wa = Fr));
    var Mp = { usingClientEntryPoint: !1, Events: [Mn, $r, Fo, ma, ga, hs] },
        Yn = {
...
function Qp() {
    ...
    return (o(), (Bs.exports = $p()), Bs.exports);
}
var sf;
function Gp() {
    if (sf) return gi;
...
const Os = Yp("DEFINITION_LOOKUP_TABLE", {}),
...
var O = $s();
const qf = Df(O),
    qs = If({ __proto__: null, default: qf }, [O]),
...
const zi = Zf() ? O.useLayoutEffect : O.useEffect,
    br = (o) => {
        const n = O.useRef(() => {
            ...
            (this._onKeyDown = (a) => {
                ...
                if (y) {
                    ...
                    if (
                        ...
                        ) && xi.moveWithPhantomDummy(f, S ?? y, !1, m, a);
                        return;
                    }
        ...
        const h = K.createMutationObserver((S) => {
                for (const C of S) {
                    ...
                    if (C.type === "attributes")
                        ...
                        for (let H = 0; H < q.length; H++) f.push({ element: q[H], type: Rs });
                    }
                }
                y();
            }),
...
class Im {
    ...
    _moveFocus(n, i, a) {
        ...
        if (
            ...
            (i === Ie.ArrowDown && C) || (i === Ie.ArrowRight && (T || q)))
        )
            if (
        ...
        else if ((i === Ie.ArrowUp && C) || (i === Ie.ArrowLeft && (T || q)))
            if (
...
const Qg = (o) => {
    ...
    Zg = O.useInsertionEffect ? O.useInsertionEffect : zi,
    e1 = (o, n) => {
    ...
    const {
        ...
        k = br((C) => {
            ...
            if (T === yi) {
                C.preventDefault();
                return;
            } else T === Ls && (C.preventDefault(), C.currentTarget.click());
        }),
        S = br((C) => {
...
function cw({ results: o }) {
    ...
    return De.jsxs(qd, {
        children: [
            De.jsx(Hd, {
                children: De.jsx(Ks, { children: n.map((i) => De.jsx(Wd, { children: i }, i)) }),
            }),
            De.jsx(Ad, {
                children: o.map((i, a) =>
                    De.jsx(
            ...
            children: [
                ...
                De.jsxs(Dd, {
                    ...
                    children: [
                        ...
                        De.jsx(Vs, { onClick: this.share, children: "Share" }),
                        f &&
                            De.jsx(jd, {
                                readOnly: !0,
                                value: f,
...
Xp.createRoot(document.getElementById("root")).render(De.jsx(fw, {}));
