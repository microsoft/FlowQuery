...
@FunctionDef({
    "description": "Returns true if no element in the list satisfies the condition.",
    "category": "predicate",
    "parameters": [
    ...
    "output": {"description": "True if no element satisfies the condition", "type": "boolean", "example": True},
    "examples": [
        "RETURN none(n IN [1, 2, 3] WHERE n > 5)",
    ],
})
class PredicateNone(PredicateFunction):
